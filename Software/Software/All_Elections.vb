Public Class All_Elections
    ...
    Private Sub All_Elections_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Right_Button_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim index As New Integer
        index = Integer.Parse(CType(sender, Button).Name)
        Dim Ongoing_Election_Page As New Ongoing_Election_Admin()
    ...
    Private Sub Back_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Back_Button.Click
        ...
        LoginPage.Show()
        LoginPage.User_Type_func(1)
        Me.Hide()
    End Sub

    Private Sub New_Election_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Dim New_Election_Page As New New_Election()
        New_Election_Page.Show()
        Me.Hide()
    End Sub
End Class
